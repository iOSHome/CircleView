...
- (void)viewDidLoad {
    ...
    // 圆圈1
    self.circleView1 = [CircleView circleViewWithFrame:CGRectMake(20, 20, 140, 140)
                                             lineWidth:2
    ...
    // 圆圈2
    self.circleView2 = [CircleView circleViewWithFrame:CGRectMake(20 + 150, 20, 140, 140)
                                             lineWidth:70
    ...
    // 圆圈3
    self.circleView3 = [CircleView circleViewWithFrame:CGRectMake(20 + 150, 20 + 150, 140, 140)
                                             lineWidth:2
                                             lineColor:[UIColor blackColor]
                                             clockWise:YES
                                            startAngle:0];
    ...
    self.circleView4 = [CircleView circleViewWithFrame:CGRectMake(0, 0, 140, 140)
                                             lineWidth:70
                                             lineColor:[UIColor blackColor]
                                             clockWise:YES
                                            startAngle:0];
